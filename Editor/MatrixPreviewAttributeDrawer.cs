...
public class MatrixPreviewAttributeDrawer : PropertyDrawer
{
    ...
    {
        return EditorGUIUtility.singleLineHeight * 5.2f;
    }
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        {
            Debug.LogWarning("Invalid attribute usage!");
            return;
        }
        ...
        EditorGUI.LabelField(labelSize, new GUIContent(property.displayName), EditorStyles.boldLabel);
